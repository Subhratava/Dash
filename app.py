...
admit_type = df["Admit Type"].unique()
iris = df2["species"].unique()
...
def generate_control_card():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Br(),
            html.P("Select Admit Type"),
            dcc.Dropdown(
                id="Admit-list",
                options=[{"label": i, "value": i} for i in admit_type],
                value=admit_type[0],
            ),
            html.Br(),
            html.P("iris"),
            dcc.Dropdown(
                id="iris-list",
                options=[{"label": i, "value": i} for i in iris],
                value=iris[0],
            ),
            html.Br(),
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Hr(),
                        dcc.Graph(id="patient_volume_hm",figure={}),
                    ],
                ),
...
def update_table(iris):
    df_temp = df2.loc[df2['species'] == iris]
    fig = px.scatter(df_temp, x="sepal_width", y="sepal_length", color="species",
